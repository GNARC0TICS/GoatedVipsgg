...
declare module "@db/schema" {
  ...
  export type InsertWagerRaceParticipant = InferInsertModel<
    typeof wagerRaceParticipants
  >;
  export type SelectWagerRaceParticipant = InferSelectModel<
    typeof wagerRaceParticipants
  >;
  ...
  export type InsertNewsletterSubscription = InferInsertModel<
    typeof newsletterSubscriptions
  >;
  export type SelectNewsletterSubscription = InferSelectModel<
    typeof newsletterSubscriptions
  >;
  ...
  export type InsertGoatedVerificationRequest = InferInsertModel<
    typeof goatedVerificationRequests
  >;
  export type SelectGoatedVerificationRequest = InferSelectModel<
    typeof goatedVerificationRequests
  >;
  export type InsertTelegramVerificationRequest = InferInsertModel<
    typeof telegramVerificationRequests
  >;
  export type SelectTelegramVerificationRequest = InferSelectModel<
    typeof telegramVerificationRequests
  >;
}
