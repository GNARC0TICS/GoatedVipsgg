      ...
      <main className="container mx-auto px-4 py-12">
        <div className="text-center mb-16">
          ...
          <motion.p
            ...
            className="text-xl text-foreground max-w-2xl mx-auto mb-8"
          >
        ...
        >
          <Link href="/vip-transfer" className="block">
            <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
              <div className="relative p-8 rounded-xl border border-muted bg-card hover:border-[#D7FF00]/50 transition-all duration-300">
                <h3 className="text-2xl font-heading uppercase mb-4">VIP Transfer</h3>
                <p className="text-foreground mb-6">Transfer your VIP status from other platforms and get cash bonuses.</p>
          ...
          <Link href="/wager-races" className="block">
            <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
              <div className="relative p-8 rounded-xl border border-muted bg-card hover:border-[#D7FF00]/50 transition-all duration-300">
                ...
                <p className="text-foreground mb-6">Compete in exclusive wager races for massive prize pools and rewards.</p>
                <span className="font-heading text-[#D7FF00] inline-flex items-center gap-2 hover:text-[#D7FF00]/80 transition-colors cursor-pointer">
          ...
          <Link href="/vip-program" className="block">
            <div className="relative group transform transition-all duration-300 hover:scale-[1.02]">
              <div className="relative p-8 rounded-xl border border-muted bg-card hover:border-[#D7FF00]/50 transition-all duration-300">
                ...
                <p className="text-foreground mb-6">Exclusive benefits like instant rakeback, level up bonuses, and monthly rewards.</p>
                <span className="font-heading text-[#D7FF00] inline-flex items-center gap-2 hover:text-[#D7FF00]/80 transition-colors cursor-pointer">
        ...
        >
          <div className="rounded-xl border border-muted bg-card p-8">
            <LeaderboardTable />
          </div>
        </motion.div>
      </main>
