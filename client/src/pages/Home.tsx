        ...
        >
          ...
          <div className="relative group">
            ...
            <div className="relative p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-colors">
              ...
              <p className="text-[#8A8B91] mb-6 font-mono font-normal">Transfer your VIP status from other platforms and get cash bonuses.</p>
          ...
          <div className="relative group">
            ...
            <div className="relative p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-colors">
              ...
              <p className="text-[#8A8B91] mb-6 font-mono font-normal">Compete in exclusive wager races for massive prize pools and rewards.</p>
          ...
          <div className="relative group">
            ...
            <div className="relative p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-colors">
              ...
              <p className="text-[#8A8B91] mb-6 font-mono font-normal">Exclusive benefits like instant rakeback, level up bonuses, and monthly rewards.</p>
        ...
        >
          ...
          <div className="relative group">
            ...
            <div className="relative p-8 rounded-xl border border-[#2A2B31] bg-[#1A1B21]/50 backdrop-blur-sm hover:border-[#D7FF00]/50 transition-colors">
              ...
              <p className="text-[#8A8B91] mb-6 font-mono font-normal">
