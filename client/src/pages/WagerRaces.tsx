        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex justify-center items-end gap-4 mt-8 mb-12">
            ...
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="relative bg-[#1A1B21]/80 backdrop-blur-sm p-4 rounded-lg border border-[#C0C0C0] w-[140px] h-[120px]"
            >
              {getTrophyIcon(2)}
            ...
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="relative bg-[#1A1B21]/80 backdrop-blur-sm p-4 rounded-lg border border-[#FFD700] w-[160px] h-[140px] -mt-4"
            >
              {getTrophyIcon(1)}
              <div className="text-center mt-2">
                <p className="text-lg font-bold truncate">{top10Players[0]?.name || '-'}</p>
            ...
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="relative bg-[#1A1B21]/80 backdrop-blur-sm p-4 rounded-lg border border-[#CD7F32] w-[140px] h-[100px]"
            >
              {getTrophyIcon(3)}
              <div className="text-center mt-2">
