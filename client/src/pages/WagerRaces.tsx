          ...
          <div className="flex flex-col items-center mb-20">
            <div className="flex justify-center items-end gap-12 mt-16">
              ...
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="relative bg-[#1A1B21]/80 backdrop-blur-sm p-6 rounded-lg border-2 border-[#C0C0C0] w-[180px] h-[160px] flex flex-col items-center"
              >
                <div className="absolute -top-10 left-1/2 -translate-x-1/2 text-[#C0C0C0] font-heading text-xl">2ND PLACE</div>
                <div className="flex justify-center mb-4">
                  {getTrophyIcon(2)}
                </div>
                <div className="text-center mt-auto">
                  <p className="text-lg font-extrabold truncate mb-2">{top10Players[1]?.name || '-'}</p>
                  <p className="text-sm font-bold text-[#D7FF00]">${getPrizeAmount(2).toLocaleString()}</p>
                </div>
              </motion.div>
              ...
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="relative bg-[#1A1B21]/80 backdrop-blur-sm p-8 rounded-lg border-2 border-[#FFD700] w-[220px] h-[180px] -mt-10 flex flex-col items-center"
              >
                <div className="absolute -top-10 left-1/2 -translate-x-1/2 text-[#FFD700] font-heading text-2xl">1ST PLACE</div>
                <div className="flex justify-center mb-6">
                  {getTrophyIcon(1)}
                </div>
                <div className="text-center mt-auto">
                  <p className="text-2xl font-extrabold truncate mb-2">{top10Players[0]?.name || '-'}</p>
                  <p className="text-lg font-bold text-[#D7FF00]">${getPrizeAmount(1).toLocaleString()}</p>
                </div>
              </motion.div>
              ...
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="relative bg-[#1A1B21]/80 backdrop-blur-sm p-6 rounded-lg border-2 border-[#CD7F32] w-[180px] h-[140px] flex flex-col items-center"
              >
                <div className="absolute -top-10 left-1/2 -translate-x-1/2 text-[#CD7F32] font-heading text-xl">3RD PLACE</div>
                <div className="flex justify-center mb-4">
                  {getTrophyIcon(3)}
                </div>
                <div className="text-center mt-auto">
                  <p className="text-lg font-extrabold truncate mb-2">{top10Players[2]?.name || '-'}</p>
                  <p className="text-sm font-bold text-[#D7FF00]">${getPrizeAmount(3).toLocaleString()}</p>
                </div>
              </motion.div>
            </div>
          </div>
