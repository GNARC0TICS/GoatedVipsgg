  ...
  if (!user?.isAdmin) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        <h1 className="text-2xl font-heading text-white mb-4">Admin Access Required</h1>
        <p className="text-[#8A8B91] mb-6">You need admin privileges to view this page.</p>
        <Link href="/">
    ...
    <PageTransition>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <Link href="/">
              <Button variant="ghost" className="p-2 hover:bg-transparent hover:text-[#D7FF00]">
                  ...
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <h3 className="text-lg font-heading text-white mb-1">{module.title}</h3>
                        <p className="text-sm text-[#8A8B91]">{module.description}</p>
                      </div>
