  ...
  return (
    <div className="min-h-screen bg-[#14151A]">
      <main className="container mx-auto px-4 py-12">
        ...
        >
          <h1 className="flex flex-col items-center gap-2 text-6xl md:text-7xl font-['MonaSansCondensed-ExtraBold'] mb-8">
            <span className="text-[#D7FF00] bg-[#1A1B21]/50 px-6 py-2 rounded-lg shadow-glow-sm">WAGER</span>
