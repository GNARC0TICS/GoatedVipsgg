    ...
    <PageTransition>
      <div className="min-h-screen bg-[#14151A] py-12">
        <main className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-white mb-8">Help & Support</h1>
            <div className="space-y-8">
              <section className="bg-[#1A1B21]/50 backdrop-blur-sm p-6 rounded-lg border border-[#2A2B31]">
                <h2 className="text-2xl font-heading text-white mb-4">24/7 Support</h2>
                <p className="text-[#8A8B91]">Our support team is available 24/7 to assist you with any questions or concerns.</p>
              </section>
