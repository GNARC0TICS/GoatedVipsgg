  ...
  "inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs font-mona-sans font-semibold uppercase tracking-wide transition-all focus:outline-none focus:ring-2 focus:ring-primary/30 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-transparent bg-background-alt text-text-primary hover:bg-border",
        destructive:
          "border-transparent bg-[#FF3D54] text-white hover:bg-[#FF3D54]/90",
        outline: "border-border text-text-primary hover:bg-background-alt",
        success:
          "border-transparent bg-[#14B87D] text-white hover:bg-[#14B87D]/90",
        warning:
          "border-transparent bg-[#FFB800] text-black hover:bg-[#FFB800]/90",
        premium:
          "border-primary/30 bg-primary/10 text-primary hover:bg-primary/20",
        ghost:
          "border-transparent bg-transparent text-text-secondary hover:bg-background-alt",
        glass:
          "border-border/50 bg-background-overlay/30 text-text-primary backdrop-blur-md hover:bg-background-overlay/40",
      },
      size: {
...
function TierBadge({
  ...
  > = {
    Bronze: {
      ...
      styles:
        "border-[#CD7F32]/30 bg-[#CD7F32]/10 text-[#CD7F32] hover:bg-[#CD7F32]/20",
    },
    Silver: {
      icon: (
        <svg
      ...
      styles:
        "border-[#C0C0C0]/30 bg-[#C0C0C0]/10 text-[#C0C0C0] hover:bg-[#C0C0C0]/20",
    },
    Gold: {
      icon: (
        <svg
    ...
    Platinum: {
      ...
      styles:
        "border-[#E5E4E2]/30 bg-[#E5E4E2]/10 text-[#E5E4E2] hover:bg-[#E5E4E2]/20",
    },
    Diamond: {
      icon: (
        <svg
      ...
      styles:
        "border-[#B9F2FF]/30 bg-gradient-to-r from-[#B9F2FF]/20 to-[#B9F2FF]/5 text-[#B9F2FF] shadow-[0_0_8px_rgba(185,242,255,0.2)]",
    },
    VIP: {
      icon: (
        <svg
      ...
      styles:
        "border-primary/30 bg-gradient-to-r from-primary/20 to-primary/5 text-primary shadow-[0_0_8px_rgba(215,255,0,0.15)] font-bold",
    },
  };
