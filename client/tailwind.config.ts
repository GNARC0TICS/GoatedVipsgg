  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'neon-strong': '0 0 15px rgba(215, 255, 0, 0.5), 0 0 30px rgba(215, 255, 0, 0.3)',
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgba(215, 255, 0, 0.3), 0 0 10px rgba(215, 255, 0, 0.1)' },
          '100%': { boxShadow: '0 0 10px rgba(215, 255, 0, 0.5), 0 0 20px rgba(215, 255, 0, 0.3)' },
        },
        wiggle: {
      ...
      backgroundImage: {
        ...
        'gradient-neon': 'linear-gradient(to bottom right, rgba(215, 255, 0, 0.3), rgba(215, 255, 0, 0))',
        'diagonal-lines': 'repeating-linear-gradient(45deg, var(--tw-gradient-from) 0, var(--tw-gradient-from) 1px, transparent 0, transparent 50%)',
      },
      spacing: {
        '18': '4.5rem',
        '22': '5.5rem',
